...
2) [MANDTORY]  Give the user friendly instructions on how to use the Testcase Generator
3) [MANDATORY] Give an option to copy paste the sample user stories for banking domain, sports, construction, real estate domain
...
9) [MANDATORY] Use red and white as background theme
